    ...
    <>
      ...
      <div className="w-[1541px] h-[882px] px-6 py-4 left-[229px] top-[158px] absolute bg-slate-800 bg-opacity-70 rounded-2xl flex-col justify-between items-start inline-flex">
        <div className="w-[1493px] h-[447px] justify-start items-start inline-flex">
          ...
          <div className="w-[610px] flex-col justify-start items-start inline-flex">
          ...
          <div className="w-[517px] flex-col justify-start items-start inline-flex">
            <div className="h-12 py-2 justify-start items-start gap-2 inline-flex">
              <div className="text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Thời gian phát
              </div>
          ...
          <div className="grow shrink basis-0 flex-col justify-center items-center inline-flex">
            ...
            <div className="self-stretch h-[47px] pt-1 flex-col justify-between items-center flex">
            ...
            <div className="self-stretch h-[47px] pt-1 flex-col justify-between items-center flex">
              <div className="w-[107px] px-4 py-[5px] rounded justify-center items-center gap-1 inline-flex">
                <div className="text-center text-orange-500 text-xs font-semibold font-['Montserrat'] underline leading-normal">
                  Xem chi tiết
                </div>
              </div>
          ...
          <div className="w-[126px] flex-col justify-start items-start inline-flex">
            ...
            <div className="self-stretch h-[47px] pt-[5px] opacity-80 flex-col justify-center items-center gap-2 flex">
              <div className="px-4 py-[5px] rounded justify-center items-center gap-1 inline-flex">
                <div className="text-center text-red-500 text-xs font-semibold font-['Montserrat'] underline leading-normal">
                  Xóa
                </div>
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
