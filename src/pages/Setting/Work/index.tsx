...
const WorkSetting = () => {
  return (
    <>
      <div className="left-[229px] top-[86px] absolute flex-col justify-start items-start inline-flex"></div>
      ...
      <div className="h-[769px] px-6 py-4 left-[229px] top-[234px] absolute bg-[#2B2B3F] bg-opacity-70 rounded-2xl flex-col justify-start items-start gap-14 inline-flex">
        <div className="self-stretch justify-start items-start inline-flex">
          ...
          <div className="grow shrink basis-0 h-[647px] flex-col justify-start items-start inline-flex">
            <div className="h-12 py-2 justify-start items-start gap-2 inline-flex">
              <div className="text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Tên thể loại
              </div>
            </div>
            <div className="self-stretch h-[47px] pt-[11px] opacity-80 flex-col justify-start items-start gap-3 flex">
              <div className="self-stretch h-6 text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                Pop
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
            ...
            <div className="self-stretch h-[35px] pt-[11px] opacity-80 flex-col justify-start items-start gap-3 flex">
              <div className="self-stretch h-6 text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                Ballad
              </div>
            </div>
            <div className="self-stretch grow shrink basis-0 pt-1 opacity-80" />
          </div>
          <div className="w-[1065px] h-[649px] flex-col justify-start items-start inline-flex">
            ...
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-start items-start gap-[15px] flex">
              <div className="text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                Nhạc pop là một thể loại của nhạc đương đại và rất phổ biến trong làng nhạc đại
                chúng.
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-start items-start gap-[15px] flex">
              <div className="text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                Quay về với một thời hoa bướm đầy mơ mộng khi nghe các tuyệt phẩm nhạc bolero trữ
                tình này.
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-start items-start gap-[15px] flex">
              <div className="text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                Ballad là dòng nhạc nhẹ nhàng, trữ tình bắt nguồn từ dòng nhạc country và folk vì
                giai điệu chậm, thong thả.{' '}
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-start items-start gap-[15px] flex">
              <div className="text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                Lo-fi là một thể loại nhạc trong đó có chứa các yếu tố không hoàn hảo trong quá
                trình ghi âm và trình diễn.
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-start items-start gap-[15px] flex">
              <div className="text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                Nhạc Blues có nguồn gốc từ những điệu hát của miền tây Phi Châu được các nô lệ da
                đen mang sang Bắc Mỹ.
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-start items-start gap-[15px] flex">
              <div className="text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                'Nhạc đồng quê' là một thể loại nhạc pha trộn truyền thống được tìm thấy phổ biến ở
                Mỹ và Canada.
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
            ...
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-start items-start gap-[15px] flex">
              <div className="text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                Rock là một thể loại âm nhạc quần chúng được bắt nguồn từ cách gọi ngắn gọn của cụm
                từ "rock and roll" vào những năm 1950 ở Mỹ.
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
