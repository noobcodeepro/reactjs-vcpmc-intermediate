    ...
    <>
      <div className="w-[1541px] h-[752px] px-6 py-4 left-[229px] top-[306px] absolute bg-slate-800 bg-opacity-70 rounded-2xl flex-col justify-start items-start gap-14 inline-flex">
        <div className="w-[1493px] h-[644px] justify-start items-start inline-flex">
          ...
          <div className="w-[227px] h-[644px] flex-col justify-start items-start inline-flex">
            <div className="h-12 pr-2 py-2 justify-start items-start gap-2 inline-flex">
              <div className="text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Đơn vị khai thác
              </div>
          ...
          <div className="w-[167px] flex-col justify-start items-start inline-flex">
            <div className="h-12 pr-2 py-2 justify-start items-start gap-2 inline-flex">
              <div className="text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Loại hợp đồng
              </div>
          ...
          <div className="w-[133px] flex-col justify-start items-start inline-flex">
            <div className="h-12 pr-2 py-2 justify-start items-start gap-2 inline-flex">
              <div className="text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Tổng lượt phát
              </div>
            ...
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-start items-start gap-[15px] flex">
              <div className="w-[108px] text-right text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                365
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
          ...
          <div className="w-[147px] flex-col justify-start items-start inline-flex">
            <div className="h-12 pr-2 py-2 justify-start items-start gap-2 inline-flex">
              <div className="text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Tổng doanh thu
              </div>
            ...
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-start items-start gap-[15px] flex">
              <div className="w-[118px] text-right text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                365.000.000
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
          ...
          <div className="w-[183px] flex-col justify-start items-start inline-flex">
            <div className="w-[162px] pr-2 py-2 justify-start items-start gap-2 inline-flex">
              <div className="w-[162px] text-center text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Doanh thu <br />
                chưa phân phối
              </div>
            </div>
          ...
          <div className="w-[141px] h-[644px] flex-col justify-start items-start inline-flex">
            <div className="h-12 pr-2 py-2 justify-start items-start gap-2 inline-flex">
              <div className="text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Ngày chốt
                <br />
            ...
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-start items-start gap-[15px] flex">
              <div className="w-[76px] text-right text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                10/07/2021
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
      ...
      <div className="left-[231px] top-[197px] absolute justify-start items-center gap-1 inline-flex">
...
export default ContrastHistory;
