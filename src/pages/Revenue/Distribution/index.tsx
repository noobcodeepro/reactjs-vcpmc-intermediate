    ...
    <>
      <div className="w-[1540px] h-[722px] px-6 py-4 left-[230px] top-[306px] absolute bg-[#2B2B3F] bg-opacity-70 rounded-2xl flex-col justify-between items-start inline-flex">
        <div className="self-stretch justify-start items-start inline-flex">
          ...
          <div className="w-[199px] flex-col justify-start items-start inline-flex">
          ...
          <div className="w-[190px] h-[644px] flex-col justify-start items-start inline-flex">
            <div className="h-12 pr-2 py-2 justify-start items-start gap-2 inline-flex">
              <div className="text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Người ủy quyền
              </div>
          ...
          <div className="w-[178px] h-[644px] flex-col justify-start items-start inline-flex">
            <div className="h-12 pr-2 py-2 justify-start items-start gap-2 inline-flex">
              <div className="text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Số bài hát ủy quyền
              </div>
            ...
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-start items-start gap-[15px] flex">
              <div className="w-[146px] text-right text-white text-sm font-normal font-['Montserrat'] leading-tight tracking-tight">
                15
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
          ...
          <div className="w-[187px] flex-col justify-start items-start inline-flex">
            <div className="h-12 pr-2 py-2 justify-start items-start gap-2 inline-flex">
              <div className="text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Hành chính phí (VNĐ)
              </div>
          ...
          <div className="w-[194px] flex-col justify-start items-start inline-flex">
            <div className="h-12 pr-2 py-2 justify-start items-start gap-2 inline-flex">
              <div className="text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Mức nhuận bút (VNĐ)
              </div>
          ...
          <div className="grow shrink basis-0 h-[644px] flex-col justify-start items-start inline-flex">
            <div className="w-[165px] h-12 pr-2 py-2 justify-center items-start gap-2 inline-flex">
              <div className="w-[154px] text-center text-orange-300 text-sm font-bold font-['Montserrat'] leading-tight tracking-tight">
                Chi tiết doanh thu
              </div>
            </div>
            <div className="self-stretch h-[47px] pt-3 opacity-80 flex-col justify-center items-center gap-[15px] flex">
              <div className="w-[75px] h-5 text-center text-orange-500 text-xs font-semibold font-['Montserrat'] underline leading-normal">
                Xem chi tiết
              </div>
              <div className="self-stretch h-[0px] opacity-30 border border-gray-500"></div>
            </div>
            ...
            <div className="self-stretch h-8 pt-3 opacity-80 flex-col justify-center items-center gap-[15px] flex">
              <div className="w-[75px] h-5 text-center text-orange-500 text-xs font-semibold font-['Montserrat'] underline leading-normal">
                Xem chi tiết
              </div>
            </div>
      ...
      <div className="left-[229px] top-[258px] absolute text-neutral-200 text-2xl font-bold font-['Montserrat'] leading-normal">
      ...
      <div className="left-[80px] top-[197px] absolute" />

      <div className="w-[372px] h-12 left-[230px] top-[186px] absolute">
        <div className="w-[264px] h-12 pl-4 pr-3 py-3 left-[108px] top-0 absolute bg-zinc-800 rounded-lg border border-gray-500 justify-between items-center inline-flex">
