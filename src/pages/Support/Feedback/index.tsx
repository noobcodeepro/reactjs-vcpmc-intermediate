...
const Feedback = () => {
  return (
    <>
      ...
      <div className="w-[764px] h-[750px] left-[651px] top-[185px] absolute bg-slate-800 bg-opacity-70 rounded-2xl">
        <div className="left-[-383px] top-[485px] absolute" />
        <div className="w-[700px] h-20 left-[32px] top-[40px] absolute">
          <div className="w-[700px] h-12 pl-4 pr-6 pt-[11px] pb-[13px] left-0 top-[32px] absolute bg-slate-800 rounded-lg justify-start items-center inline-flex">
        ...
        <div className="w-[700px] h-20 left-[32px] top-[144px] absolute">
          <div className="w-[700px] h-12 pl-4 pr-3 py-3 left-0 top-[32px] absolute bg-slate-800 rounded-lg border border-gray-500 justify-between items-center inline-flex">
        ...
        <div className="w-[700px] h-[332px] left-[32px] top-[248px] absolute">
          ...
          <div className="w-[700px] h-[300px] pl-4 pr-6 py-3 left-0 top-[32px] absolute bg-slate-800 rounded-lg border border-gray-500 justify-start items-start inline-flex">
            <div className="text-gray-500 text-base font-normal font-['Montserrat'] leading-normal">
              Nhập nội dung
            </div>
          </div>
